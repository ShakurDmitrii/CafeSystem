...
public class Keys {
    ...
    public static final UniqueKey<ConsproductRecord> CONSPRODUCT_PK = Internal.createUniqueKey(Consproduct.CONSPRODUCT, DSL.name("consproduct_pk"), new TableField[] { Consproduct.CONSPRODUCT.CONSIGNMENTID }, true);
    ...
    public static final ForeignKey<ClientdishRecord, DishRecord> CLIENTDISH__CLIENTDISH_DISH_FK = Internal.createForeignKey(Clientdish.CLIENTDISH, DSL.name("clientdish_dish_fk"), new TableField[] { Clientdish.CLIENTDISH.DISHID }, Keys.DISH_PK, new TableField[] { Dish.DISH.DISHID }, true);
    ...
    public static final ForeignKey<FavoriteproductRecord, ProductRecord> FAVORITEPRODUCT__FAVORITEPRODUCT_PRODUCT_FK = Internal.createForeignKey(Favoriteproduct.FAVORITEPRODUCT, DSL.name("favoriteproduct_product_fk"), new TableField[] { Favoriteproduct.FAVORITEPRODUCT.PRODUCTID }, Keys.PRODUCT_PK, new TableField[] { Product.PRODUCT.PRODUCTID }, true);
    ...
    public static final ForeignKey<ProductwarehouseidRecord, ProductRecord> PRODUCTWAREHOUSEID__PRODUCTWAREHOUSEID_PRODUCT_FK_1 = Internal.createForeignKey(Productwarehouseid.PRODUCTWAREHOUSEID, DSL.name("productwarehouseid_product_fk_1"), new TableField[] { Productwarehouseid.PRODUCTWAREHOUSEID.PRODUCTID }, Keys.PRODUCT_PK, new TableField[] { Product.PRODUCT.PRODUCTID }, true);
