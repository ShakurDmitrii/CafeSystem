...
public class Product extends TableImpl<ProductRecord> {
     ...
     */
    public final TableField<ProductRecord, BigDecimal> WASTE = createField(DSL.name("waste"), SQLDataType.NUMERIC, this, "");
    ...
    /**
     * Get the implicit to-many join path to the <code>sales.warehouse</code>
     * table
     */
    public WarehousePath warehouse() {
        if (_warehouse == null)
            _warehouse = new WarehousePath(this, null, Keys.WAREHOUSE__WAREHOUSE_PRODUCT_FK.getInverseKey());
     ...
     */
    public <U> SelectField<U> mapping(Function5<? super Integer, ? super Integer, ? super String, ? super BigDecimal, ? super BigDecimal, ? extends U> from) {
     ...
     * Function)}.
     */
    public <U> SelectField<U> mapping(Class<U> toType, Function5<? super Integer, ? super Integer, ? super String, ? super BigDecimal, ? super BigDecimal, ? extends U> from) {
